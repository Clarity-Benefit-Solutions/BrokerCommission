...
CREATE VIEW [dbo].[COMMISSION_RESULT_NAME1]
AS
    (
    SELECT
...
CREATE VIEW [dbo].[COMMISSION_RESULT_NAME2]
AS
    (
    SELECT
...
CREATE VIEW [dbo].[COMMISSION_RESULT_NAME3]
AS
    (
    SELECT
...
CREATE VIEW [dbo].[COMMISSION_RESULT_NAME4]
AS
    (
    SELECT
...
CREATE VIEW [dbo].[COMMISSION_RESULT_NAME5]
AS
    (
    SELECT
...
CREATE VIEW [dbo].[COMMISSION_RESULT_NAME6]
AS
    (
    SELECT
...
create VIEW [dbo].[COMMISSION_SUMMARY_PREV]
AS
