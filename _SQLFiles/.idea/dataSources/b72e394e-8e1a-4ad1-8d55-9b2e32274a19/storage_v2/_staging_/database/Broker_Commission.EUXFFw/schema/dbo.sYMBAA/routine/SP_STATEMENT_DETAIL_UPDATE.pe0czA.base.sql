...
While ( SELECT COUNT(*) FROM [dbo].[STATEMENT_HEADER] WHERE FLAG = 0  ) > 0
Begin
    Select Top 1 @Id = HEADER_ID From [dbo].[STATEMENT_HEADER] Where FLAG = 0 
	...
	WHERE R.[QB_CLIENT_NAME] IS NOT NULL AND HEADER.HEADER_ID =  @Id  
