...
ALTER TABLE [dbo].[db_message_log]
    ADD DEFAULT (getdate( )) FOR [created_at]
GO
...
create or
alter PROCEDURE [dbo].[db_log_message](
...
create or
alter PROCEDURE [dbo].[db_log_error](
                                    @err_no varchar(50),
...
create or
alter PROCEDURE [dbo].[db_throw_error](
                                      @err_no nvarchar(50),
