...
namespace Decrypt
{
    class Program
    {
        ...
        {
            #region Decryption
            string inputfile =  @"E:\\SmartData\\FTPDownload\\Enrolled_Participant_Report_04022022.csv.pgp";
            string privateKeyFile = @"E:\\SmartData\\FTPDATA\\Alfred Zhu.asc";
            string passPhrase =  "AlfredZhu";
            string outputFile = "E:\\SmartData\\FTPDownload\\Enrolled_Participant_Report_04022022_Result.csv";
            Decrypt(inputfile, privateKeyFile, passPhrase, outputFile);
            #endregion
            #region encryption
            //string inputFile = @"C:\\DecryptionProcess\\Test\\TestFile.csv";

            //string outputFile = @"C:\\DecryptionProcess\\Test\\output\\TestResult.pgp";
            //string publicKeyFile = @"C:\\DecryptionProcess\\Test\\PublicKey\\Manojjaswal_Pkey.asc";
            //bool armor = true;
            //bool withIntegrityCheck = true;
            //EncryptFile(inputFile, outputFile, publicKeyFile, armor, withIntegrityCheck);
            #endregion
