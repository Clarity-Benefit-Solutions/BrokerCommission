<%@ Page Title="" Language="C#" MasterPageFile="~/Light.master" AutoEventWireup="true" CodeBehind="ViewFile.aspx.cs" Inherits="Broker_Commission.ViewFile" %>
                                    ...
                                    <Columns>
                                     ...
                                     <%--      <dx:GridViewDataTextColumn FieldName="START_DATE" ShowInCustomizationForm="True" VisibleIndex="10" Caption="START_DATE" Width="10%">
                                        ...
                                        <dx:GridViewDataColumn Caption="Edit" VisibleIndex="10" Width="120px">
                                            ...
                                            <DataItemTemplate>
                                                <dx:ASPxButton runat="server" ID="btn_detlete" Visible='<%#string.IsNullOrEmpty( Eval("BROKER_STATUS").ToString())? true:false %>' Text="DELETE" Theme="Mulberry" CommandName="delete"
                                                    CommandArgument='<%# Eval("START_DATE") %>'>
                                                </dx:ASPxButton>
                                            </DataItemTemplate>
                        ...
                        <ContentCollection>
                            <dx:ContentControl runat="server" SupportsDisabledAttribute="True">
                                <div style="width: 100%; text-align: right; margin-bottom: 20px">
                                    ...
                                    &nbsp;&nbsp;
                                    <dx:ASPxButton runat="server" ID="ASPxButton1" Text="SEND STATEMENT" Theme="Moderno" OnClick="btn_state_OnClick"></dx:ASPxButton>
                                    &nbsp;&nbsp;
                                    <dx:ASPxButton runat="server" ID="btn_edit" Text="DOWNLOAD" Theme="Moderno" OnClick="btn_edit_OnClick">
                                    </dx:ASPxButton>
                                </div>
                                <asp:Literal runat="server" ID="lbl_literal"></asp:Literal>
