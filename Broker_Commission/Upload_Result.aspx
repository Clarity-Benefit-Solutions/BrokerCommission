<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="Upload_Result.aspx.cs" Inherits="Broker_Commission.Upload_Result" %>
        ...
        <div class="col-lg-10">
            ...
            <dx:ASPxGridView ID="grid_summary" runat="server" ClientInstanceName="ASPxGridView1" Theme="Moderno" OnRowCommand="grid_summary_OnRowCommand" OnPageIndexChanged="grid_summary_OnPageIndexChanged"
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn FieldName="BROKER_NAME" VisibleIndex="0" FixedStyle="Left" Width="40%" Caption="BROKER NAME">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="PAYLOCITY_ID" VisibleIndex="0" FixedStyle="Left" Width="20%" Caption="PAYLOCITY ID">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="TOTAL" VisibleIndex="1" Width="20%" Caption="COMMISSION AMOUNT($)">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataColumn Caption="VIEW STATEMENT" VisibleIndex="2" Width="20%">
