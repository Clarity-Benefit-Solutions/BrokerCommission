        ...
        <div class="col-10" style="margin-left: 50px;">
            ...
            <dx:ASPxGridView ID="grid_broker" runat="server" AutoGenerateColumns="False" OnPageIndexChanged="ASPxGridView1_OnPageIndexChanged"
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn FieldName="BROKER_NAME" VisibleIndex="1" FixedStyle="Left" HeaderStyle-HorizontalAlign="Center" Width="240px" Caption="BROKER NAME">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="BROKER_NAME_ID" VisibleIndex="1" HeaderStyle-HorizontalAlign="Center" Width="170px" Caption="QB BROKER NAME">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataColumn Caption="TOTAL AMOUNT($)" VisibleIndex="1" HeaderStyle-HorizontalAlign="Center" CellStyle-HorizontalAlign="Center" Width="150px" FixedStyle="Left">
                    ...
                    <dx:GridViewDataColumn Caption="BROKER STATUS" VisibleIndex="2" HeaderStyle-HorizontalAlign="Center" Width="130px">
                        <SettingsHeaderFilter>
                            <DateRangePickerSettings EditFormatString=""></DateRangePickerSettings>
                        </SettingsHeaderFilter>
                        <DataItemTemplate>
                    ...
                    <dx:GridViewDataColumn Caption="ELITE PROGRESS" VisibleIndex="2" HeaderStyle-HorizontalAlign="Center" Width="200px">
                        <SettingsHeaderFilter>
                            <DateRangePickerSettings EditFormatString=""></DateRangePickerSettings>
                        </SettingsHeaderFilter>
                        <DataItemTemplate>
                    ...
                    <dx:GridViewDataTextColumn FieldName="EMAIL" VisibleIndex="3" HeaderStyle-HorizontalAlign="Center" Width="280px">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="PAYLOCITY_ID" VisibleIndex="4" HeaderStyle-HorizontalAlign="Center" CellStyle-HorizontalAlign="Center" Caption="PAYLOCITY ID" Width="105px">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="NOTES" VisibleIndex="5" HeaderStyle-HorizontalAlign="Center" Caption="NOTES" Width="200px">
                    </dx:GridViewDataTextColumn>
                    ...
                    <dx:GridViewDataColumn Caption="VIEW" VisibleIndex="10" HeaderStyle-HorizontalAlign="Center" CellStyle-HorizontalAlign="Center" Width="110px">
                        <SettingsHeaderFilter>
                            <DateRangePickerSettings EditFormatString=""></DateRangePickerSettings>
                        </SettingsHeaderFilter>
                        <DataItemTemplate>
            ...
            <dx:ASPxPageControl ID="ASPxPageControl1" runat="server" ActiveTabIndex="0" Theme="Moderno" Width="100%">
                <TabPages>
                    ...
                    <dx:TabPage Name="ELITE BROKER" Text="ELITE BROKER">
                        <ContentCollection>
                            <dx:ContentControl runat="server" SupportsDisabledAttribute="True">
                                <dx:WebChartControl ID="WebChartControl2" runat="server" Height="600px" Width="1575px" IndicatorsPaletteName="Chameleon" PaletteName="Civic" ToolTipEnabled="True" CrosshairEnabled="True">
                    ...
                    <dx:TabPage Name="REGULAR BROKER" Text="REGULAR">
                        <ContentCollection>
                            <dx:ContentControl runat="server" SupportsDisabledAttribute="True">
                                <dx:WebChartControl ID="WebChartControl1" runat="server" Height="700px" Width="1575px" IndicatorsPaletteName="Chameleon"
